...
const Auth = () => {
  ...
  // Handle newly registered user that needs onboarding
  // The app_metadata.onboarded flag is created during registration by default as false
  // Once onboarding is completed, it's set to true
  const isNewUser = user && user.app_metadata?.onboarded === false;
  
  // If user is authenticated but needs onboarding, show onboarding
