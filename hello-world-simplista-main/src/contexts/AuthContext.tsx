...
type AuthContextType = {
  ...
  isLoading: boolean;
  signUp: (email: string, password: string, metadata: { full_name: string, professional_title?: string, industry?: string, phone_number?: string }) => Promise<{ error: any | null }>;
  ...
  updateUserMetadata: (metadata: Record<string, any>) => Promise<{ error: any | null }>;
};
...
export const AuthProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const signUp = async (email: string, password: string, metadata: { full_name: string, professional_title?: string, industry?: string, phone_number?: string }) => {
    try {
